...
Motion::Project::App.setup do |app|
  ...
  app.name = 'redpotion-kitchen-sink'
  app.identifier = 'com.your_domain_here.redpotion-kitchen-sink'
  ...
  app.development do
    ...
    app.provisioning_profile = "signing/redpotion-kitchen-sink.mobileprovision"
  end
